          ...
          <div className="container pb-8 sm:pb-0">
            <div className="grid grid-cols-1 sm:grid-cols-2">
              ...
              <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                ...
                At Flipside Flavors, our mission is to elevate your burger experiences by blending creativity with tradition. We strive to curate an atmosphere where every burger tells a story, inviting patrons to savor moments and flavors that transcend the ordinary. Welcome to a burger journey like no other.
                </p>
